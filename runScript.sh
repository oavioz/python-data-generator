...
cp -r python-data-generator/* .
    ...
    python3 create_tenants_cvs_files.py 2 tenants  ~/Workspace/Dojo/user-service/output/tenants/ 1000
    # Create subscriptions csv files
    python3 create_subscriptions_cvs_files.py 2 subscriptions  ~/Workspace/Dojo/user-service/output/subscriptions/ 10000
    ...
    python3 create_subscription_roles_csv_files.py 2 subscription_roles_temp  ~/Workspace/Dojo/user-service/output/subscription_roles_temp/ 10000
# Load csv file for each table
    ...
    python3 users-service-data-pump.py ~/Workspace/Dojo/user-service/output/tenants
    # Load subscriptions csv files into subscriptions table
    python3 users-service-data-pump.py ~/Workspace/Dojo/user-service/output/subscriptions
    # Load subscription_roles_temp csv files into subscription_roles_temp table
    python3 users-service-data-pump.py ~/Workspace/Dojo/user-service/output/subscription_roles_temp/
